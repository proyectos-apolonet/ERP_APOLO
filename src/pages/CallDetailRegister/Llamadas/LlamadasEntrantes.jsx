...
import { getCDRLlamadasEntrantes, getFiltrosCDRLlamadasEntrantes } from '../../../api/CDR/CDRService';


const LlamadasEntrantes = () => {

  const [fechaInicio, setFechaInicio] = useState("");
  const [fechaFin, setFechaFin] = useState("");

  // Opciones reales de cada <select>, sacadas de la base de datos (no una
  // lista fija a mano) -- se cargan una sola vez al entrar a la página.
