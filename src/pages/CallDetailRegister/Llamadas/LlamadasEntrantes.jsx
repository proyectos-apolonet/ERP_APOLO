...
import { getCDRLlamadasEntrantes } from '../../../api/CDR/CDRService';
...
const LlamadasEntrantes = () => {
  ...
  const getInfoCDRLlamadasEntrantes = async () => {

    try {
      setLoading(true);

      const tempoCDR = await getCDRLlamadasEntrantes();
      setData(tempoCDR);
