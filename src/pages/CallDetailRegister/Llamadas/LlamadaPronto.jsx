...
import { getCDRLlamadasPronto } from '../../../api/CDR/CDRService';
...
const LlamadaPronto = () => {
  ...
  const getInfoCDRLlamadasPronto = async () => {

    try {
      setLoading(true);

      const tempoCDR = await getCDRLlamadasPronto();
      setData(tempoCDR);
